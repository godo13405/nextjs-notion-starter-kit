...
> = ({ site, title, description, image, url }) => {
  ...
  const socialImageUrl = image || "https://images.unsplash.com/photo-1531246939076-ffdd8e9ea293?ixlib=rb-4.0.3&q=85&fm=jpg&w=1200&h=628&crop=focalpoint&fit=crop&cs=srgb"
